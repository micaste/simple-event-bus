...
var ListMap = __webpack_require__(45);
...
var EventBus = function () {
  ...
  function EventBus() {
    ...
    this.broker = broker ? broker : function (action) {
  ...
  (0, _createClass3.default)(EventBus, [{
    key: 'on',
    value: function on(action, handler, handlerId) {
      var _this = this;

      var insertionId = this.handlers.add(action, { handler: handler, handlerId: handlerId });
      return function () {
        return _this.handlers.remove(action, insertionId);
      };
    }
    ...
    value: function emit(action) {
      ...
      // don't do anything.
      this.handlers.forEach(action, function (_ref2) {
        var handler = _ref2.handler,
            handlerId = _ref2.handlerId;

        // We isolate the handlers so that if one errors, it still calls the others.
        try {
          handler.apply(undefined, (0, _toConsumableArray3.default)(_this2.broker.apply(_this2, [action].concat(args))));
        } catch (e) {
          _this2.logger.error((handlerId !== undefined ? 'The handler ' + handlerId : 'A handler') + ' has errored:', e.message, e.stack);
        }
      });
    }
  }, {
    key: 'handlersCount',
    value: function handlersCount(action) {
...
var ListMap = function () {
  function ListMap() {
    (0, _classCallCheck3.default)(this, ListMap);
  ...
  (0, _createClass3.default)(ListMap, [{
    ...
    key: "remove",
    value: function remove(key, itemId) {
      if (this.map[key] !== undefined) {
    ...
    key: "forEach",
    value: function forEach(key, callback) {
      if (this.map[key] !== undefined) {
        this.map[key].storage.forEach(function (value) {
          return (
    ...
    value: function get(key) {
      return this.map[key] !== undefined ? (0, _from2.default)(this.map[key].storage.values()) : [];
    }
  }, {
    key: "size",
